...
fig1 = px.line(df_butsData, x="x", y=["buts inscrits","buts encaissés"], labels={"x":"Nombre de match", "value":"Nombre de buts"})
...
fig2 = px.line(df_penaltyData, x="x", y=["penaltys inscrits","penaltys encaissés"], labels={"x":"Nombre de match", "value":"Nombre de penaltys"})
